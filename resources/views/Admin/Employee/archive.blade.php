                                                                ...
                                                                <div class="custom-dropdown-group">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                            <a class="dropdown-item" href="{{route('admin.employee.restore' , $employee->id)}}">Restore</a>
                                                                            <a class="dropdown-item" href="{{route('admin.employee.force.delete' , $employee->id)}}">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
