				...
				<div class="main-container">
					...
					<div class="row gutters">
                        ...
                        {{--  end message section  --}}
								...
								<div class="t-header">AidReciept Campaign Archive Table</div>
                                        ...
                                        <tr>
											...
											<td>
												@foreach ($AidRecieptCampaign->AidReceivingCampaignVehicle as $aidVehicle)
													{{$aidVehicle->vehicle->name}} - {{$aidVehicle->vehicle->type}} - {{$aidVehicle->vehicle->Capacity}}
												@endforeach
											</td>
											<td>
                                            ...
                                            <td>{{$AidRecieptCampaign->deleted_at}}</td>
                                            <td>
                                                <div class="row gutters">
                                                    <div class="col-sm-12">
                                                        <div class="card-body">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('admin.AidRecieptCampaigns.restore', $AidRecieptCampaign->id) }}">Restore</a>
                                                                        <form method="post" action="{{ route('admin.AidRecieptCampaigns.forceDelete', $AidRecieptCampaign->id) }}">
                                                                            @csrf
                                                                            @method('delete')
