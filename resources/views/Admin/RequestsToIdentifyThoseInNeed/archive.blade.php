                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">Requests to identify those in need Archive Table</div>
                            <div class="table-responsive">
                                <table id="basicExample" class="table custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($IdentifyThoseInNeeds as $IdentifyThoseInNeed)
                                            <tr>
                                                <td>{{ $IdentifyThoseInNeed->name }}</td>
                                                <td>{{ $IdentifyThoseInNeed->email }}</td>
                                                <td>{{ $IdentifyThoseInNeed->phone }}</td>
                                                <td>
                                                    @if ($IdentifyThoseInNeed->status == 1)
                                                ...
                                                <td>{{ $IdentifyThoseInNeed->address }}</td>
                                                <td>{{ $IdentifyThoseInNeed->street }}</td>
                                                <td>{{ $IdentifyThoseInNeed->admin->name ?? '-' }}</td>
                                                <td>{{ $IdentifyThoseInNeed->created_at }}</td>
                                                <td>{{ $IdentifyThoseInNeed->deleted_at }}</td>
                                                <td>
                                                    <div class="row gutters">
                                                        <div class="col-sm-12">
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            aria-labelledby="dropdownMenuButton">
                                                                                ...
                                                                                <form method="get"
                                                                                    action="{{ route('admin.IdentifyThoseInNeed.restore', $IdentifyThoseInNeed->id) }}">
                                                                                    @csrf
                                                                            ...
                                                                            <form method="post"
                                                                                action="{{ route('admin.IdentifyThoseInNeed.forceDelete', $IdentifyThoseInNeed->id) }}">
                                                                                @csrf
                                                                                @method('delete')
                                                                                <button class="dropdown-item"
