                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">Requests to identify those in need Table</div>
                                                                ...
                                                                <div class="custom-dropdown-group">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            @if ($IdentifyThoseInNeed->status == 0)
                                                                                <form method="post"
                                                                                    action="{{ route('admin.IdentifyThoseInNeed.seen', $IdentifyThoseInNeed->id) }}">
                                                                                    @csrf
                                                                                    @method('put')
                                                                            ...
                                                                            <form method="post"
                                                                                action="{{ route('admin.IdentifyThoseInNeed.softDelete', $IdentifyThoseInNeed->id) }}">
                                                                                @csrf
                                                                                @method('delete')
                                                                                <button class="dropdown-item"
