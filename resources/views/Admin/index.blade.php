								...
								<div class="card-body">
									<div class="customScroll5">
										<ul class="recent-orders">
											<li>
												<div class="order-img">
													<img src="img/orders/order5.png" alt="Smart Dashboards">
											...
											<li>
												<div class="order-img">
													<img src="img/orders/order6.png" alt="Smart Dashboards">
											...
											<li>
												<div class="order-img">
													<img src="img/orders/order3.png" alt="Smart Dashboards">
													<span class="badge badge-danger">On Hold</span>
												</div>
												<div class="order-details">
											...
											<li>
												<div class="order-img">
													<img src="img/orders/order1.png" alt="Smart Dashboards">
											...
											<li>
												<div class="order-img">
													<img src="img/orders/order4.png" alt="Smart Dashboards">
													<span class="badge badge-success">Delivered</span>
												</div>
												<div class="order-details">
											...
											<li>
												<div class="order-img">
													<img src="img/orders/order2.png" alt="Smart Dashboards">
													<span class="badge badge-danger">On Hold</span>
												</div>
												<div class="order-details">
									...
									<div class="customScroll5">
										<div class="timeline-activity">
											<div class="activity-log">
												...
												<div class="log-details">GoldFinch dashboard has been created<span
											...
											<div class="activity-log">
												...
												<div class="log-details">
													...
													<div class="stacked-images mt-1">
														<img class="sm" src="img/user.png" alt="Admin Panel Website Templates">
														<img class="sm" src="img/user2.png" alt="Admin Panel Website Templates">
														<img class="sm" src="img/user3.png" alt="Admin Panel Website Templates">
														<img class="sm" src="img/user4.png" alt="Admin Panel Website Templates">
											...
											<div class="activity-log">
												...
												<div class="log-details">
													Farewell day photos uploaded.
													<div class="stacked-images mt-1">
														<img class="sm" src="img/user5.png" alt="Admin Panel Website Templates">
														<img class="sm" src="img/user22.png" alt="Admin Panel Website Templates">
					...
					<div class="row gutters">
						<div class="col-lg-6 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<a href="#" class="graph-notify" data-toggle="tooltip" data-placement="left" title=""
