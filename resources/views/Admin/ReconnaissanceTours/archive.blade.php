                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">Reconnaissance Tours Archive Table </div>
                            <div class="table-responsive">
                                <table id="basicExample" class="table custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($ReconnaissanceTours as $ReconnaissanceTour)
                                            <tr>
                                                <td>{{ $ReconnaissanceTour->name }}</td>
                                                <td>{{ $ReconnaissanceTour->date }}</td>
                                                <td>{{ $ReconnaissanceTour->startTime }}</td>
                                                <td>{{ $ReconnaissanceTour->endTime }}</td>
                                                <td>{{ $ReconnaissanceTour->priority }}</td>
                                                <td>{{ $ReconnaissanceTour->note }}</td>
                                                <td>
                                                    @foreach ($ReconnaissanceTour->ReconnaissanceToursEmployee as $ReconnaissanceToursEmployee)
                                                ...
                                                <td>
                                                    @foreach ($ReconnaissanceTour->ReconnaissanceToursVehicle as $ReconnaissanceToursVehicle)
                                                ...
                                                <td>
                                                    @foreach ($ReconnaissanceTour->ReconnaissanceTourLocation as $ReconnaissanceTourLocation)
                                                        {{ $ReconnaissanceTourLocation->address }} -
                                                        {{ $ReconnaissanceTourLocation->street }}
                                                    @endforeach
                                                </td>
                                                <td>{{ $ReconnaissanceTour->admin->name }}</td>
                                                <td>{{ $ReconnaissanceTour->created_at }}</td>
                                                <td>{{ $ReconnaissanceTour->deleted_at }}</td>
                                                <td>
                                                    <div class="row gutters">
                                                        <div class="col-sm-12">
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('admin.ReconnaissanceTours.restore', $ReconnaissanceTour->id) }}">Restore</a>
                                                                            <form method="post"
                                                                                action="{{ route('admin.ReconnaissanceTours.forceDelete', $ReconnaissanceTour->id) }}">
                                                                                @csrf
                                                                                @method('delete')
