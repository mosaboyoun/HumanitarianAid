                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">Reconnaissance Tours Table </div>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('admin.ReconnaissanceTours.edit', $ReconnaissanceTour->id) }}">Edit</a>
                                                                            <form method="post"
                                                                                action="{{ route('admin.ReconnaissanceTours.softDelete', $ReconnaissanceTour->id) }}">
                                                                                @csrf
                                                                                @method('delete')
