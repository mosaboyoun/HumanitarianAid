								...
								<div class="table-responsive">
									...
									<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$associate->street}}</td>
                                            <td>{{$associate->anotherDetails}}</td>
                                            <td>{{$associate->created_at}}</td>
                                            <td>{{$associate->admin->name}}</td>
                                            <td>
                                                <div class="row gutters">
                                                    <div class="col-sm-12">
                                                                ...
                                                                <div class="custom-dropdown-group">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                            <a class="dropdown-item" href="{{route('admin.association.edit' , $associate->id)}}">Edit</a>
                                                                            <a class="dropdown-item" href="{{route('admin.association.edit.location' , $associate->id)}}">Edit Location</a>
                                                                            <a class="dropdown-item" href="{{route('admin.association.changePassword.page' , $associate->id)}}">Change Password</a>
                                                                            <a class="dropdown-item" href="{{route('admin.association.soft.delete' , $associate->id)}}">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
