...
<html lang="en">
			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<!-- Breadcrumb start -->
						<ol class="breadcrumb">
							<li class="breadcrumb-item">Update Association Location</li>
						</ol>
						<!-- Breadcrumb end -->
					...
					<div class="row gutters">
                        ...
                        {{--  end message section  --}}
                                ...
                                <form action="{{route('admin.association.update.location' , $association->id)}}" method="POST">
                                    @csrf
                                    @method('put')
								<div class="card-body">
    ...
    <script>
        ...
        function initMap() {
            ...
            var myLatLng = {
                lat: parseFloat("{{$association->latitude}}"),
                lng: parseFloat("{{$association->longitude}}")
