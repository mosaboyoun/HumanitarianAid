			...
			<div class="page-content">
				...
				<div class="main-container">
					...
					<div class="page-header">
						...
						<!-- Breadcrumb start -->
						<ol class="breadcrumb">
							<li class="breadcrumb-item">Edit Donors</li>
						</ol>
						<!-- Breadcrumb end -->
									...
									<div class="row gutters">
										<div class="col-sm-4 col-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="inputName" placeholder="Enter Donor Name"
                                                value="{{$donor->name}}" name="name" required>
											</div>
										</div>
										<div class="col-sm-4 col-12">
											<div class="form-group">
                                                ...
                                                value="{{$donor->email}}" name="email" required>
											</div>
										</div>
                                        <div class="col-sm-4 col-12">
											<div class="form-group">
                                        ...
                                        <div class="col-sm-4 col-12">
											<div class="form-group">
                                                ...
                                                value="{{$donor->age}}" name="age"required>
											</div>
										</div>
                                        <div class="col-sm-4 col-12">
											<div class="form-group">
                                                ...
                                                value="{{$donor->phone}}" name="phone" required>
											</div>
										</div>
                                        <div class="col-sm-4 col-12">
											<div class="form-group">
                                                ...
                                                value="{{$donor->address}}" name="address" required>
											</div>
										</div>
										<div class="col-sm-4 col-12">
											<div class="form-group">
												...
												<select class="form-control form-control-lg" name="status" required>
													<option value="1"
                                                    {{$donor->status === 1 ? 'selected' : ''}}>Active</option>
                                                    <option value="0"
                                                    {{$donor->status === 0 ? 'selected' : ''}}>Not Active</option>
												</select>
											</div>
										</div>
									</div>
