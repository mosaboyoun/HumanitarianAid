...
<body>
                    ...
                    <div class="dropdown">
                        <a class="btn btn-outline-primary py-2 px-3 dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="d-inline-flex btn-sm-square bg-white text-primary rounded-circle ms-2">
                                <img src="img/team-4.jpg" alt="Avatar" class="rounded-circle" style="width: 24px; height: 24px;">
                            </div>
                        </a>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 pt-5">
                                    ...
                                    <p class="fs-5 text-white-50 mb-5 animated slideInDown">Non profit charity website.</p>
                    ...
                    <div class="h-100 bg-white p-5">
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <select class="form-select bg-light border-0" id="selectProject" aria-label="Select Project">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="img/association (1).png"
                ...
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="img/association (2).png"
                        style="width: 100px; height: 100px;">
                    <div class="testimonial-text rounded text-center p-4">
                        <p>Description of the association's involvement or support.</p>
                        <h5 class="mb-1">Association Name</h5>
                ...
                <div class="testimonial-item text-center">
                    <img class="img-fluid bg-light rounded-circle p-2 mx-auto mb-4" src="img/association (3).png"
                        style="width: 100px; height: 100px;">
                    <div class="testimonial-text rounded text-center p-4">
                        <p>Description of the association's involvement or support.</p>
                        <h5 class="mb-1">Association Name</h5>
